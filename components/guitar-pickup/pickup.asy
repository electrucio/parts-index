...
SYMATTR Value L=2.5 R=6k C=110p Rx=500k kx=0.5
SYMATTR Prefix X
SYMATTR SpiceModel pickup
SYMATTR ModelFile guitar-pickup.sub
SYMATTR Description Magnetic guitar pickup: EMF-driven coil with eddy loss, DCR, winding C. Pins OUT GND EMF
PIN 96 32 NONE 8
PINATTR PinName OUT
