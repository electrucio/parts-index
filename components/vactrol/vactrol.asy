...
SYMATTR Value Rref=19.85k gamma=0.8299 m=1.987 Rs=154.7 tau=3.896m ka=0.1394 hist=0
SYMATTR Prefix X
SYMATTR SpiceModel vactrol
SYMATTR ModelFile vactrol.sub
SYMATTR Description LED/LDR optocoupler (vactrol). Pins A K C1 C2
PIN 0 16 NONE 8
PINATTR PinName A
