...
SYMATTR Value L=500m R=17 Qc=0 Cp=0
SYMATTR Prefix X
SYMATTR SpiceModel wah_inductor
SYMATTR ModelFile wah-inductor.sub
SYMATTR Description Wah inductor: L with winding resistance, optional core loss and self-capacitance. Pins A B
PIN 16 16 NONE 8
PINATTR PinName A
